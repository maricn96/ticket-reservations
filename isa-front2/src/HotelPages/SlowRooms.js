...
class SlowRooms extends Component{
    ...
    componentDidMount() {
        ...
        axios.post("http://localhost:8080/sobe/spora/" + id, {datumOd: sessionStorage.getItem('vremePoletanja'), datumDo: sessionStorage.getItem('vremeSletanja')})
        .then(res=>{
            this.setState({
                sobe: res.data
            })
...
export default withRouter(SlowRooms)